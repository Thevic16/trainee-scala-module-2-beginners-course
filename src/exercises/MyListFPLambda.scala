...
object ListTest extends App {
  ...
  val transformerDouble: Int => Int = (v1: Int) =>  v1 * 2
  ...
  val filterEven: Int => Boolean = (v1: Int) => if (v1 % 2 == 0) true else false
   ...
   */
  val transformerIntToMyList: Int => MyList[Int] = (elem: Int) => new Cons[Int](elem, new Cons[Int](elem + 1, Empty))
